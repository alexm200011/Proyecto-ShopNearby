...
namespace pryShopNearby.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idPropietario,Nombres,Apellidos,Cedula,N_Telefono,Usuario,Contrasena")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idPropietario,Nombres,Apellidos,Cedula,N_Telefono,Usuario,Contrasena")] Propietario propietario)
        {
            if (ModelState.IsValid)
            {
